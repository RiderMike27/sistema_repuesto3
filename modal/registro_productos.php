	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Agregar nuevo Accesorio</h4>
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="guardar_producto" name="guardar_producto">
			<div id="resultados_ajax_productos"></div>
			  <div class="form-group">
				<label for="codigo" class="col-sm-3 control-label">Código - Serie</label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				<label for="nombre" class="col-sm-3 control-label">Repuesto</label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				<label for="estado" class="col-sm-3 control-label">Marca</label>
				<div class="col-sm-8">
				...
				<div class="form-group">
				<label for="estado" class="col-sm-3 control-label">Modelo</label>
				<div class="col-sm-8">
				 <select class="form-control" id="estado" name="estado" required>
					<option value="">-- Selecciona estado --</option>
					<option value="1" selected>Activo</option>
